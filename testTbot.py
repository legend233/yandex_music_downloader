...
from config import telegramm_token, telegramm_token_test

bot = telebot.TeleBot(telegramm_token_test)
...
def input_data_artist(message):
    try:
        ...
        bot.send_message(message.chat.id,
                         f'Что-то пошло не так при поиске информации о артисте {artist}. Посмотри логи.')
